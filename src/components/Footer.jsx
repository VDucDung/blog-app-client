      ...
      <footer className="container mx-auto grid grid-cols-10 gap-x-5 gap-y-10 px-5 py-10 md:grid-cols-12 md:pt-20 lg:grid-cols-10 lg:gap-x-10">
        ...
        <div className="col-span-10 md:order-first md:col-span-4 lg:col-span-2">
          ...
          <ul className="mt-5 flex items-center justify-center space-x-4 text-gray-300 md:justify-start">
            <li>
              <a href="/">
                <AiOutlineTwitter className="h-auto w-6 hover:text-primary" />
              </a>
            </li>
            <li>
              <a href="/">
                <AiFillYoutube className="h-auto w-6 hover:text-[#FF0000]" />
              </a>
            </li>
            <li>
              <a href="/">
                <AiFillInstagram className="h-auto w-6 hover:text-[#E1306C]" />
              </a>
            </li>
            <li>
              <a href="/">
                <FaFacebook className="h-auto w-6 hover:text-[#4267B2]" />
              </a>
            </li>
            <li>
              <a href="/">
                <BsTelegram className="h-auto w-6 hover:text-[#0088CC]" />
              </a>
            </li>
          </ul>
        </div>
